<%-- 
    ...
    Created on : Jan 18, 2015, 11:16:13 AM
    Author     : User
--%>
...
<div class="container"><marquee direction="left">
  ...
  <div class="content">
    <ul id="MenuBar1" class="MenuBarHorizontal">
      <li><a href="emp_reg.html">EMPLOYEE REGISTRATION</a>    </li>
      <li><a class="MenuBarItemSubmenu" href="#">UPDATE MOVIE</a>
      <ul>
        <li><a href="update_current_movie.html">Current movie</a></li>
        <li><a href="movies.jsp">Movie of the week</a></li>
      </ul>
      </li>
       <li><a href="#">UPDATE POSTER</a></li> 
